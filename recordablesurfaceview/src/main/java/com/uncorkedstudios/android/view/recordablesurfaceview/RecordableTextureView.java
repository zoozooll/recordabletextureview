...
public class RecordableTextureView extends TextureView
        implements TextureView.SurfaceTextureListener,
        View.OnLayoutChangeListener {

    final static String TAG = "RecordableTextureView";
...
//    private ImageReader mImageReader;
     ...
     */
    public RecordableTextureView(Context context) {
        super(context);
        init();
    }
     ...
     * must call {@link #setRenderer} to register a renderer.
     */
    public RecordableTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
